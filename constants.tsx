...
export const TESTIMONIALS: Testimonial[] = [
  ...
  { id: '26', name: 'Dr. Riya Malhotra', company: 'Care Plus Hospital', designation: 'Senior Surgeon', content: 'GPP handles our medical reports and prescription pads with utmost precision. The paper quality is excellent and the print is crystal clear.', avatarUrl: '/testimonials/avatar-26.jpg' }
];
